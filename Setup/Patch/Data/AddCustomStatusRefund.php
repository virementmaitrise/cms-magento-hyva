...
class AddCustomStatusRefund implements DataPatchInterface
{
    ...
    public const ORDER_STATUS_PARTIAL_REFUND_CODE = 'virementmaitrise_partial_refund';

    /** Custom partial refund order-status label */
    public const ORDER_STATUS_PARTIAL_REFUND_LABEL = 'Virement Maitrisé Partial Refund';
